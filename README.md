...
[![Live Demo](https://img.shields.io/badge/demo-live-green)](https://itsocialist.github.io/rlc-ai-roi-calculator/)
...
```bash
git clone https://github.com/itsocialist/rlc-ai-roi-calculator.git
...
Your calculator will be live at: `https://itsocialist.github.io/rlc-ai-roi-calculator/`

### Embed in Website

```html
<iframe 
  src="https://itsocialist.github.io/rlc-ai-roi-calculator/" 
  width="100%" 
  height="1200px" 
  frameborder="0">
</iframe>
...
Found a calculation error or display bug? [Create an issue](https://github.com/itsocialist/rlc-ai-roi-calculator/issues)
...
[Create a GitHub issue](https://github.com/itsocialist/rlc-ai-roi-calculator/issues)
